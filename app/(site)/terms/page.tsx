    ...
    <div className="container mx-auto md:px-6 px-4 pt-32 pb-12 max-w-3xl">
      <div className="prose prose-lg max-w-none">
        ...
        <div className="notice-caution p-4 mb-8">
          ...
          <p className="text-caution-700 dark:text-caution-400 text-sm">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-rb-500 mb-4">1. Acceptance of Terms</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-rb-500 mb-4">3. No Financial Advice</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-rb-500 mb-4">5. Acceptable Use</h2>
          <p className="text-rb-500 mb-4">You agree not to:</p>
          <ul className="list-disc pl-6 mb-4 text-rb-500">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-rb-500 mb-4">6. Intellectual Property</h2>
          <p className="text-rb-500 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-rb-500 mb-4">8. Limitation of Liability</h2>
          <p className="text-rb-500 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-rb-500 mb-4">9. Indemnification</h2>
          <p className="text-rb-500 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-rb-500 mb-4">11. Modifications</h2>
          <p className="text-rb-500 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-rb-500 mb-4">12. Termination</h2>
          <p className="text-rb-500 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-rb-500 mb-4">13. Governing Law</h2>
          <p className="text-rb-500 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-rb-500 mb-4">14. Contact Information</h2>
          <p className="text-rb-500 mb-4">For questions about these Terms, please contact us:</p>
